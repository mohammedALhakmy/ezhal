...
if(isset($_POST['send_request'])) {
  ...
  if(isset($_POST['trip_id'], $_POST['first_name'], $_POST['last_name'], $_POST['sirname'], $_POST['date_brith'], $_POST['naionality'], $_POST['ID_Card'], $_POST['country_emission'], $_POST['Expiration'], $_POST['email'], $_POST['phone'])) {
    ...
    $query = "INSERT INTO trips_order (trip_id, first_name, last_name, sirname, date_brith, naionality, ID_Card, country_emission, Expiration, email, phone) 
