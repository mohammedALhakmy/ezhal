...
<?php include('master.php');?>
  ...
  <div class="subscribe-box">
    <div class="subscribe-header">
      <h2 class="subscribe-title">  اشترك لمعرفة جديد إزهل </h2>
      <img src="img/logoe.png" alt="Logo" class="subscribe-image">
      <form action="process_subscription1.php" method="post">
        <input type="email" id="subscribeEmail" name="email" placeholder="أدخل بريدك الإلكتروني" required class="subscribe-input">
        <button type="submit">إرسال</button>
            ...
            <footer id="footer" class="footer-1">
                ...
                <h5 class="widget-title">انتقال سريع<span></span></h5>
