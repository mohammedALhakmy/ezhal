...
<style>
    ...
    .btn1 {
        background-color: #06657A !important;
    ...
    <!-- Spinner End -->
        ...
        <?php include 'master.php' ?>
            ...
            <div class="container-1">
                <div class="content">
                    <h4> نموذج تعبئة البنزين</h3>
                        <div class="form-container">

                            <form class="form-group" action="php/gasolin.php" method="post">
                                <!-- Number of cylinders -->
                                <label for="type-of-gasoline">نوع الوقود<p class="star-required">*</p></label>
                                <select id="type-of-gasoline" name="type_of_gasoline" required>
                                    <option value=""> اخترنوع وقود</option>
                                ...
                                <!-- gasolin liters -->
                                <label for="gasolin-of-liters">لتر البنزين<p class="star-required">*</p></label>
                                <input type="text" id="gasolin-of-liters" name="gasolin-of-liters" placeholder="ادخل كمية البنزين" required>

                                <!-- User location -->
                                <label for="user-location">موقع المستخدم<p class="star-required">*</p></label>
                                <input type="text" id="user-location" name="user_location" placeholder="ادخل موقعك" required>
                                <a href="location.html">
                                    <i class="fa fa-map-marker-alt" style="font-size: 24px; color: #ffffff;margin-right: 5px;" aria-hidden="true">
                                    </i></a>

                                <!-- Submit button -->
                                <button type="submit" class="btn1" <?php isset($_SESSION['user_id']) ?>>إرسال
                                    الطلب</button>
                            </form>
                        </div>
                </div>
