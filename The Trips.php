...
<form class="options" onsubmit="return validateForm()" action="./detail of the trip page.php" method="post">
          <div class="row">
            ...
            <ul class="list">
            <li style="display: flex; align-items: center;"><p style="font-size: 18px !important; margin: 0;"> نوع الرحلة : <?php if($item['date_back'] == ''){echo 'ذهاب';}else{echo 'ذهاب و اياب';}?></p></li>
