...
<?php   include('master.php');?>
            ...
            <div class="container-1">
                <div class="content">
                    <h4> نموذج تعبئة الغاز</h3>
                        <div class="form-container">
                            <form class="form-group" action="php/gaz.php" method="post">

                                <!-- Number of cylinders -->
                                <label for="number-of-cylinders">عدد الاسطوانات<p class="star-required">*</p></label>
                                <input type="number" id="number-of-cylinders" name="number_of_cylinders" placeholder="ادخل عدد الاسطوانات" required>
                                <!-- More options can be added here -->


                                <!-- Volume of cylinder -->
                                <label for="volume-of-cylinder">حجم الاسطوانة<p class="star-required">*</p></label>
                                <select id="volume-of-cylinder" name="volume_of_cylinder" required>
                                ...
                                <fieldset>
                                    ...
                                    <label>
                                        <input type="radio" name="packaging" value="existing">
                                        تعبئة
                                    </label>
                                    <label>
                                        <input type="radio" name="packaging" value="new">
                                        جديد
                                    </label>
                                </fieldset>
